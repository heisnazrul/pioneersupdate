...
<div class="main-content py-10">
  ...
  <form action="{{ route('admin.language-school-course-material-fees.store') }}" method="POST" class="space-y-4">
    @csrf
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <div>
        ...
        <input type="number" min="1" name="billing_count" value="{{ old('billing_count', 1) }}" class="mt-1 block w-full border rounded-md px-3 py-2" required>
      </div>
    </div>
