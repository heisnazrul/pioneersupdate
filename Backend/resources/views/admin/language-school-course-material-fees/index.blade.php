...
<div class="main-content py-10">
  <div class="flex justify-between py-10">
    ...
    <a href="{{ route('admin.language-school-course-material-fees.create') }}" class="ti-btn rounded-full ti-btn-outline ti-btn-outline-primary">Add Material Fee</a>
  </div>
  ...
  <div class="bg-white rounded-lg shadow-md p-4 mb-6">
    <form method="GET" action="{{ route('admin.language-school-course-material-fees.index') }}" class="grid grid-cols-1 md:grid-cols-5 gap-4">
      <div>
      ...
      <div class="md:col-span-5 flex items-end gap-2">
        ...
        <a href="{{ route('admin.language-school-course-material-fees.index') }}" class="ti-btn rounded-full border">Reset</a>
      </div>
    </form>
  </div>
    ...
    <table class="min-w-full bg-white">
      ...
      <tbody>
        ...
        <tr class="border-b">
          ...
          <td class="px-6 py-4 text-sm">
            <a href="{{ route('admin.language-school-course-material-fees.edit', $fee) }}" class="text-blue-600 hover:text-blue-800">Edit</a>
            <form action="{{ route('admin.language-school-course-material-fees.destroy', $fee) }}" method="POST" class="inline-block" onsubmit="return confirm('Delete this material fee?');">
              @csrf
              @method('DELETE')
