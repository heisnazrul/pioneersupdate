...
<div class="main-content py-10">
  <div class="flex justify-between py-10">
    <h2 class="text-2xl font-bold mb-4">Create Language Course Type</h2>
  ...
  <form action="{{ route('admin.language-course-types.store') }}" method="POST" class="space-y-4">
    @csrf

    <div>
      <label class="block text-sm font-medium text-gray-700">Type Code</label>
      <input type="text" name="type_code" value="{{ old('type_code') }}" class="mt-1 block w-full border rounded-md px-3 py-2" required>
    </div>
