...
<div class="main-content py-10">
  <div class="flex justify-between py-10">
    <h2 class="text-2xl font-bold mb-4">Create Language Course Tag</h2>
  ...
  <form action="{{ route('admin.language-course-tags.store') }}" method="POST" class="space-y-4">
    @csrf

    <div>
      <label class="block text-sm font-medium text-gray-700">Tag Code</label>
      <input type="text" name="tag_code" value="{{ old('tag_code') }}" class="mt-1 block w-full border rounded-md px-3 py-2" required>
    </div>
