    ...
    <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
        <div class="flex flex-col gap-6">
            <div class="flex justify-between items-center">
                <h5 class="text-xl font-semibold mb-0">Edit Campus: {{ $campus->name }}</h5>
                <a href="{{ route('admin.campuses.index') }}" class="ti-btn ti-btn-light !m-0">
                ...
                <div class="box-body !p-6">
                    <form action="{{ route('admin.campuses.update', $campus->id) }}" method="POST">
                        ...
                        <div class="flex justify-end mt-6 gap-2">
                            <button type="submit" class="ti-btn ti-btn-primary !m-0">Update Campus</button>
                        </div>
                    </form>
                </div>
            </div>
