    ...
    <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
        <div class="flex flex-col gap-6">
            <div class="flex justify-between items-center">
                <h5 class="text-xl font-semibold mb-0">Edit FAQ</h5>
                    ...
                    <form action="{{ route('admin.faqs.update', $faq->id) }}" method="POST">
                        ...
                        <div class="grid grid-cols-12 gap-6">
                            ...
                            <div class="col-span-12 md:col-span-6">
                                ...
                                <input type="text" name="ar_category" value="{{ $faq->ar_category }}"
                            ...
                            <div class="col-span-12 md:col-span-6">
                                ...
                                <input type="text" name="ar_question" value="{{ $faq->ar_question }}"
                                    class="form-control w-full rounded-md">
                            </div>

                            <div class="col-span-12 md:col-span-6">
                                <label class="block text-sm font-medium mb-2">Answer (EN)</label>
                                <textarea name="answer" rows="5" class="form-control w-full rounded-md"
                                    required>{{ $faq->answer }}</textarea>
                            </div>
                            <div class="col-span-12 md:col-span-6">
                                <label class="block text-sm font-medium mb-2">Answer (AR)</label>
                                <textarea name="ar_answer" rows="5"
                                    class="form-control w-full rounded-md">{{ $faq->ar_answer }}</textarea>
                            </div>
                        </div>
                        <div class="mt-6">
                            <button type="submit" class="ti-btn ti-btn-primary">Update FAQ</button>
                        </div>
                    </form>
                </div>
            </div>
