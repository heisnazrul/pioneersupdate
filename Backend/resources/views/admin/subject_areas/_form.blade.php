<div class="grid grid-cols-12 gap-6">
    <div class="col-span-12 md:col-span-6">
        ...
        <input type="text"
            ...
            id="name" name="name" value="{{ old('name', $subjectArea->name ?? '') }}"
    ...
    <div class="col-span-12 md:col-span-6">
        ...
        <input type="text"
            class="form-control w-full bg-gray-50 border-gray-200 focus:bg-white hover:border-primary focus:border-primary focus:ring focus:ring-primary/20 transition-all rounded-md text-sm py-2.5"
            id="key" name="key" value="{{ old('key', $subjectArea->key ?? '') }}" placeholder="e.g. computer_science"
            required>
    </div>

    <div class="col-span-12 md:col-span-6">
        <label for="slug" class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">Slug</label>
        <input type="text"
            class="form-control w-full bg-gray-50 border-gray-200 focus:bg-white hover:border-primary focus:border-primary focus:ring focus:ring-primary/20 transition-all rounded-md text-sm py-2.5"
            id="slug" name="slug" value="{{ old('slug', $subjectArea->slug ?? '') }}"
    ...
    <div class="col-span-12 md:col-span-3">
        ...
        <input type="number"
            class="form-control w-full bg-gray-50 border-gray-200 focus:bg-white hover:border-primary focus:border-primary focus:ring focus:ring-primary/20 transition-all rounded-md text-sm py-2.5"
            id="sort_order" name="sort_order" value="{{ old('sort_order', $subjectArea->sort_order ?? 0) }}"
            placeholder="0">
    </div>
    ...
    <div class="col-span-12 md:col-span-3">
        ...
        <select name="is_active" id="is_active"
            class="form-control w-full bg-gray-50 border-gray-200 focus:bg-white hover:border-primary focus:border-primary focus:ring focus:ring-primary/20 transition-all rounded-md text-sm py-2.5">
            <option value="1" {{ old('is_active', $subjectArea->is_active ?? 1) == 1 ? 'selected' : '' }}>Active</option>
            <option value="0" {{ old('is_active', $subjectArea->is_active ?? 1) == 0 ? 'selected' : '' }}>Inactive
            </option>
        </select>
    </div>
</div>