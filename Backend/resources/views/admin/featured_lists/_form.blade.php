<div class="grid grid-cols-12 gap-6">
    <div class="col-span-12 md:col-span-6">
        ...
        <input type="text"
            ...
            id="name" name="name" value="{{ old('name', $featuredList->name ?? '') }}"
            placeholder="e.g. Top UK Universities" required>
    </div>
    ...
    <div class="col-span-12 md:col-span-6">
        ...
        <input type="text"
            class="form-control w-full bg-gray-50 border-gray-200 focus:bg-white hover:border-primary focus:border-primary focus:ring focus:ring-primary/20 transition-all rounded-md text-sm py-2.5"
            id="key" name="key" value="{{ old('key', $featuredList->key ?? '') }}" placeholder="e.g. top_uk_unis"
            required>
        <p class="text-xs text-gray-400 mt-1">Unique identifier (snake_case).</p>
    </div>
    ...
    <div class="col-span-12 md:col-span-6">
        ...
        <select name="is_active" id="is_active"
            class="form-control w-full bg-gray-50 border-gray-200 focus:bg-white hover:border-primary focus:border-primary focus:ring focus:ring-primary/20 transition-all rounded-md text-sm py-2.5">
            <option value="1" {{ old('is_active', $featuredList->is_active ?? 1) == 1 ? 'selected' : '' }}>Active</option>
            <option value="0" {{ old('is_active', $featuredList->is_active ?? 1) == 0 ? 'selected' : '' }}>Inactive
            </option>
        </select>
    </div>
</div>
