                    ...
                    <tbody>
                        ...
                        <td class="!p-[0.65rem]">
                          <div class="flex items-center min-w-[200px]">
                            <div class="ltr:mr-2 rtl:ml-2 leading-none">
                              <img src="../assets/img/users/11.jpg" alt=""
                      ...
                      <tr>
                        <td class="!p-[0.65rem]">
                          <div class="flex items-center min-w-[200px]">
                            <div class="ltr:mr-2 rtl:ml-2 leading-none">
                              <img src="../assets/img/users/13.jpg" alt=""
                                class="avatar avatar-xs rounded-full bg-gray-100 dark:bg-black/20">
                            </div>
                            <div class="items-center">
                ...
                <ul class="flex flex-col">
                    ...
                    <a href="javascript:void(0);" class="w-full">
                      <div class="flex items-center">
                        <div class="leading-none">
                          <img class="avatar avatar-sm rounded-full" src="../assets/img/users/2.jpg" alt="image">
                        </div>
                  ...
                  <li class="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white">
                    <a href="javascript:void(0);" class="w-full">
                      <div class="flex items-center">
                        <div class="leading-none">
                          <img class="avatar avatar-sm rounded-full" src="../assets/img/users/12.jpg" alt="image">
                        </div>
                        <div class="flex-auto ltr:ml-2 rtl:mr-2">
                  ...
                  <li class="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white">
                    <a href="javascript:void(0);" class="w-full">
                      <div class="flex items-center">
                        <div class="leading-none">
                          <img class="avatar avatar-sm rounded-full" src="../assets/img/users/13.jpg" alt="image">
                        </div>
                        <div class="flex-auto ltr:ml-2 rtl:mr-2">
                  ...
                  <li class="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white">
                    <a href="javascript:void(0);" class="w-full">
                      <div class="flex items-center">
                        <div class="leading-none">
                          <img class="avatar avatar-sm rounded-full" src="../assets/img/users/3.jpg" alt="image">
                        </div>
                        <div class="flex-auto ltr:ml-2 rtl:mr-2">
                  ...
                  <li class="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white">
                    <a href="javascript:void(0);" class="w-full">
                      <div class="flex items-center">
                        <div class="leading-none">
                          <img class="avatar avatar-sm rounded-full" src="../assets/img/users/4.jpg" alt="image">
                        </div>
                        <div class="flex-auto ltr:ml-2 rtl:mr-2">
                  ...
                  <li class="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white">
                    <a href="javascript:void(0);" class="w-full">
                      <div class="flex items-center">
                        <div class="leading-none">
                          <img class="avatar avatar-sm rounded-full" src="../assets/img/users/14.jpg" alt="image">
                        </div>
                        <div class="flex-auto ltr:ml-2 rtl:mr-2">
                  ...
                  <li class="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white">
                    <a href="javascript:void(0);" class="w-full">
                      <div class="flex items-center">
                        <div class="leading-none">
                          <img class="avatar avatar-sm rounded-full" src="../assets/img/users/5.jpg" alt="image">
                        </div>
                        <div class="flex-auto ltr:ml-2 rtl:mr-2">
                  ...
                  <li class="p-0 mb-0 ti-list-group border-0 text-gray-800 dark:text-white">
                    <a href="javascript:void(0);" class="w-full">
                      <div class="flex items-center">
                        <div class="leading-none">
                          <img class="avatar avatar-sm rounded-full" src="../assets/img/users/15.jpg" alt="image">
                        </div>
                        <div class="flex-auto ltr:ml-2 rtl:mr-2">
              ...
              <div class="box-body">
                <ul class="flex flex-col">
                  <li class="mb-6 !rounded-sm ti-list-group text-gray-800 dark:text-white w-full">
                    <div class="sm:flex items-center w-full">
                      <a href="javascript:void(0);" class="ltr:pr-4 rtl:pl-4 inline-block">
                        <img src="../assets/img/media/1.jpg" alt="img" class="avatar w-28 h-28 rounded-sm">
                      </a>
                        ...
                        <div class="md:flex justify-between items-center">
                          <div class="flex items-center" title="Instructor">
                            <a href="javascript:void(0);" class="ltr:pr-2 rtl:pl-2">
                              <img src="../assets/img/users/3.jpg" alt="img" class="avatar avatar-xs rounded-full">
                            </a>
                  ...
                  <li class="mb-6 !rounded-sm ti-list-group text-gray-800 dark:text-white w-full">
                    <div class="sm:flex items-center w-full">
                      <a href="javascript:void(0);" class="ltr:pr-4 rtl:pl-4 inline-block">
                        <img src="../assets/img/media/4.jpg" alt="img" class="avatar w-28 h-28 rounded-sm">
                      </a>
                      <div class="mt-4 sm:mt-0 flex-1 font-semibold">
                        <a href="javascript:void(0);"
                          class="text-gray-500 dark:text-white/70 block mb-1 font-medium text-xs" title="Category"><i
                        ...
                        <div class="md:flex justify-between items-center">
                          <div class="flex items-center" title="Instructor">
                            <a href="javascript:void(0);" class="ltr:pr-2 rtl:pl-2">
                              <img src="../assets/img/users/4.jpg" alt="img" class="avatar avatar-xs rounded-full">
                            </a>
                  ...
                  <li class="mb-0 !rounded-sm ti-list-group text-gray-800 dark:text-white w-full">
                    <div class="sm:flex items-center w-full">
                      <a href="javascript:void(0);" class="ltr:pr-4 rtl:pl-4 inline-block">
                        <img src="../assets/img/media/23.jpg" alt="img" class="avatar w-28 h-28 rounded-sm">
                      </a>
                      <div class="mt-4 sm:mt-0 flex-1 font-semibold">
                        <a href="javascript:void(0);"
                          class="text-gray-500 dark:text-white/70 block mb-1 font-medium text-xs" title="Category"><i
                        ...
                        <div class="md:flex justify-between items-center">
                          <div class="flex items-center" title="Instructor">
                            <a href="javascript:void(0);" class="ltr:pr-2 rtl:pl-2">
                              <img src="../assets/img/users/12.jpg" alt="img" class="avatar avatar-xs rounded-full">
                            </a>
                  ...
                  <table class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                    ...
                    <tbody class="">
                      <tr class="">
                        ...
                        <td>
                          <div class="flex space-x-3 rtl:space-x-reverse text-start">
                            <img class="avatar avatar-sm rounded-sm" src="../assets/img/media/1.jpg" alt="Image Description">
                      ...
                      <tr class="">
                        ...
                        <td>
                          <div class="flex space-x-3 rtl:space-x-reverse text-start">
                            <img class="avatar avatar-sm rounded-sm" src="../assets/img/media/4.jpg" alt="Image Description">
                            <div class="block my-auto">
                      ...
                      <tr class="">
                        ...
                        <td>
                          <div class="flex space-x-3 rtl:space-x-reverse text-start">
                            <img class="avatar avatar-sm rounded-sm" src="../assets/img/media/10.jpg" alt="Image Description">
                            <div class="block my-auto">
                      ...
                      <tr class="">
                        ...
                        <td>
                          <div class="flex space-x-3 rtl:space-x-reverse text-start">
                            <img class="avatar avatar-sm rounded-sm" src="../assets/img/media/15.jpg" alt="Image Description">
                            <div class="block my-auto">
                      ...
                      <tr class="">
                        ...
                        <td>
                          <div class="flex space-x-3 rtl:space-x-reverse text-start">
                            <img class="avatar avatar-sm rounded-sm" src="../assets/img/media/23.jpg" alt="Image Description">
                            <div class="block my-auto">
