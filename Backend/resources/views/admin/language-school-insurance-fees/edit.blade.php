...
<div class="main-content py-10">
    ...
    <form action="{{ route('admin.language-school-insurance-fees.update', $insuranceFee) }}" method="POST" class="space-y-4">
        ...
        <div>
            ...
            <input type="text" name="ar_name" id="ar_name" value="{{ old('ar_name', $insuranceFee->ar_name) }}"
        ...
        <div>
            ...
            <select name="branch_id" id="branch_id"
                ...
                @foreach($branches as $branch)
                    <option value="{{ $branch->id }}" @selected(old('branch_id', $insuranceFee->branch_id) == $branch->id)>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="number" step="0.01" min="0" name="amount" id="amount" value="{{ old('amount', $insuranceFee->amount) }}"
                       class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm sm:text-sm" required>
            </div>
