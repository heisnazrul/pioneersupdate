...
<div class="main-content py-10">
    <div class="flex justify-between py-10">
        <h2 class="text-2xl font-bold mb-4">Create Discount</h2>
        <a href="{{ route('admin.language-school-discounts.index') }}" class="ti-btn rounded-full ti-btn-outline ti-btn-outline-primary">
            Back to Discounts
        </a>
    </div>

    <form action="{{ route('admin.language-school-discounts.store') }}" method="POST" class="space-y-6">
        @include('admin.language-school-discounts._form', ['discount' => null, 'countries' => $countries, 'branches' => $branches])
