...
<div class="main-content py-10">
  <div class="flex justify-between py-10">
    <h2 class="text-2xl font-bold mb-4">Create Bedroom Type</h2>
  ...
  <form action="{{ route('admin.bedroom-types.store') }}" method="POST" class="space-y-4">
    @csrf

    <div>
      <label class="block text-sm font-medium text-gray-700">Bedroom Code</label>
      <input type="text" name="bedroom_code" value="{{ old('bedroom_code') }}" class="mt-1 block w-full border rounded-md px-3 py-2" required>
    </div>
