...
return new class extends Migration {
    ...
    {
        Schema::create('language_course_online_courses', function (Blueprint $table): void {
            $table->id();
            ...
            $table->index('language_school_id', 'idx_lc_online_school');
            $table->index('course_type_id', 'idx_lc_online_type');
            $table->index('tag_id', 'idx_lc_online_tag');
            $table->index('status', 'idx_lc_online_status');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('language_course_online_courses');
    }
};
