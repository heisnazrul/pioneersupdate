...
$filePath = '/Users/macbookpro/Desktop/pioneersedufull/Backend/app/Http/Controllers/Api/UniversityApiController.php';
...
// A list of methods to replace block by block
$replacements = [
    // 1. hero
    [
        'pattern' => '/public function hero\(Request \$request\): JsonResponse\s*\{.*?\n    \}/s',
        'replace' => <<<'CODE'
...
CODE
    ...
    // 2. homeCms
    [
        'pattern' => '/public function homeCms\(Request \$request\): JsonResponse\s*\{.*?\n    \}/s',
        'replace' => <<<'CODE'
...
CODE
    ...
    // 3. certificate
    [
        'pattern' => '/public function certificate\(Request \$request\): JsonResponse\s*\{.*?\n    \}/s',
        'replace' => <<<'CODE'
...
CODE
    ...
    // 4. homeDestinations
    [
        'pattern' => '/public function homeDestinations\(Request \$request\): JsonResponse\s*\{.*?\n    \}/s',
        'replace' => <<<'CODE'
...
CODE
    ...
    // 5. homeUniversities
    [
        'pattern' => '/public function homeUniversities\(Request \$request\): JsonResponse\s*\{.*?\n    \}/s',
        'replace' => <<<'CODE'
...
CODE
    ...
    // 6. homeReviews
    [
        'pattern' => '/public function homeReviews\(Request \$request\): JsonResponse\s*\{.*?\n    \}/s',
        'replace' => <<<'CODE'
...
CODE
    ...
    // 7. homeScholarships
    [
        'pattern' => '/public function homeScholarships\(Request \$request\): JsonResponse\s*\{.*?\n    \}/s',
        'replace' => <<<'CODE'
...
CODE
    ...
    // 8. homeBlogs
    [
        'pattern' => '/public function homeBlogs\(Request \$request\): JsonResponse\s*\{.*?\n    \}/s',
        'replace' => <<<'CODE'
...
CODE
    ...
    // 9. homeFaqs
    [
        'pattern' => '/public function homeFaqs\(Request \$request\): JsonResponse\s*\{.*?\n    \}/s',
        'replace' => <<<'CODE'
...
CODE
    ...
    // 10. countries
    [
        'pattern' => '/public function countries\(Request \$request\): JsonResponse\s*\{.*?\n    \}/s',
        'replace' => <<<'CODE'
...
CODE
    ...
    // 11. intakes
    [
        'pattern' => '/public function intakes\(Request \$request\): JsonResponse\s*\{.*?\n    \}/s',
        'replace' => <<<'CODE'
...
CODE
    ...
    // 12. levels
    [
        'pattern' => '/public function levels\(Request \$request\): JsonResponse\s*\{.*?\n    \}/s',
        'replace' => <<<'CODE'
...
CODE
    ...
    // 13. subjectAreas
    [
        'pattern' => '/public function subjectAreas\(Request \$request\): JsonResponse\s*\{.*?\n    \}/s',
        'replace' => <<<'CODE'
...
CODE
    ...
    // 14. cities
    [
        'pattern' => '/public function cities\(Request \$request\): JsonResponse\s*\{.*?\n    \}/s',
        'replace' => <<<'CODE'
...
CODE
    ...
    // 15. courses
    [
        'pattern' => '/public function courses\(Request \$request\): JsonResponse\s*\{.*?\n    \}/s',
        'replace' => <<<'CODE'
...
CODE
    ...
    // 16. universities
    [
        'pattern' => '/public function universities\(Request \$request\): JsonResponse\s*\{.*?\n    \}/s',
        'replace' => <<<'CODE'
...
CODE
    ...
    // 17. destinations
    [
        'pattern' => '/public function destinations\(Request \$request\): JsonResponse\s*\{.*?\n    \}/s',
        'replace' => <<<'CODE'
...
CODE
    ...
    // 18. navbarDestinations
    [
        'pattern' => '/public function navbarDestinations\(Request \$request\): JsonResponse\s*\{.*?\n    \}/s',
        'replace' => <<<'CODE'
...
CODE
    ...
    // 19. destinationGuides
    [
        'pattern' => '/public function destinationGuides\(Request \$request\): JsonResponse\s*\{.*?\n    \}/s',
        'replace' => <<<'CODE'
...
CODE
    ...
    // 20. accommodationRooms
    [
        'pattern' => '/public function accommodationRooms\(\): JsonResponse\s*\{.*?\n    \}/s',
        'replace' => <<<'CODE'
...
CODE
    ...
    // 21. offices
    [
        'pattern' => '/public function offices\(\): JsonResponse\s*\{.*?\n    \}/s',
        'replace' => <<<'CODE'
...
CODE
    ...
    // 22. courseShow
    [
        'pattern' => '/public function courseShow\(Request \$request, string \$slug\): JsonResponse\s*\{.*?\n    \}/s', 
        'replace' => <<<'CODE'
...
CODE
    ...
    // 23. universityShow
    [
        'pattern' => '/public function universityShow\(Request \$request, string \$slug\): JsonResponse\s*\{.*?\n    \}/s',
        'replace' => <<<'CODE'
...
CODE
    ...
    // 24. destinationShow
    [
        'pattern' => '/public function destinationShow\(Request \$request, string \$slug\): JsonResponse\s*\{.*?\n    \}/s',
        'replace' => <<<'CODE'
...
CODE
    ...
    // 25. cmsPage
    [
        'pattern' => '/public function cmsPage\(Request \$request, string \$slug\): JsonResponse\s*\{.*?\n    \}/s',
        'replace' => <<<'CODE'
...
CODE
    ...
    // 26. featureByKey
    [
        'pattern' => '/public function featureByKey\(string \$key, Request \$request\): JsonResponse\s*\{.*?\n    \}/s',
        'replace' => <<<'CODE'
...
CODE
    ...
    // 27. accommodationRoomShow
    [
        'pattern' => '/public function accommodationRoomShow\(string \$slug\): JsonResponse\s*\{.*?\n    \}/s',
        'replace' => <<<'CODE'
...
CODE
    ...
    // 28. officeShow
    [
        'pattern' => '/public function officeShow\(string \$slug\): JsonResponse\s*\{.*?\n    \}/s',
        'replace' => <<<'CODE'
...
foreach ($replacements as $replacement) {
    if (!preg_match($replacement['pattern'], $content)) {
        echo "Failed to match pattern!\n";
    }
    $content = preg_replace($replacement['pattern'], $replacement['replace'], $content);
}

file_put_contents($filePath, $content);
echo "UniversityApiController cached successfully.\n";
