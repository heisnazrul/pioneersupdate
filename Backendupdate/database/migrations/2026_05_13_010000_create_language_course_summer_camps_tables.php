...
return new class extends Migration
{
    ...
    {
        Schema::create('language_course_summer_camps', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('language_course_summer_camp_details', function (Blueprint $table) {
            $table->id();
            $table->foreignId('camp_id')
                ->unique()
                ->constrained('language_course_summer_camps')
                ->cascadeOnDelete();
