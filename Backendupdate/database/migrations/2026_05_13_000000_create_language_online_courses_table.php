...
return new class extends Migration
{
    ...
    {
        Schema::create('language_online_courses', function (Blueprint $table) {
            $table->id();
            $table->string('slug', 160)->unique();
            $table->foreignId('language_school_id')
            ...
            $table->index('language_school_id', 'idx_language_online_school');
            $table->index('course_type_id', 'idx_language_online_type');
            $table->index('status', 'idx_language_online_status');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('language_online_courses');
    }
};
