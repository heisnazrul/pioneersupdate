    ...
    public function run(): void
    {
        ...
        $groups = [
            'GB' => [
                ...
                ['Cheltenham', 'شلتنهام'], ['Plymouth', 'بليموث'],
            ],
            'US' => [
                ['New York', 'نيويورك'], ['Los Angeles', 'لوس أنجلوس'], ['Chicago', 'شيكاغو'],
                ['Boston', 'بوسطن'], ['San Diego', 'سان دييغo'], ['Berkeley', 'بيركلي'],
            ],
            'CA' => [['Toronto', 'تورونتو'], ['Vancouver', 'فانكوفر'], ['Montreal', 'مونتريال'], ['Calgary', 'كalgary']],
            'AU' => [['Sydney', 'سيدني'], ['Melbourne', 'ملبورن'], ['Brisbane', 'بريسبان']],
            'DE' => [['Berlin', 'برلين'], ['Munich', 'ميونخ'], ['Frankfurt', 'فرانكفورت']],
            'IE' => [['Dublin', 'دبلن'], ['Cork', 'كورك'], ['Galway', 'غالواي'], ['Athlone', 'أثلون']],
