...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
    <div class="lg:col-span-2 space-y-6">
        <div class="bg-white dark:bg-gray-800 shadow-sm border border-gray-100 dark:border-gray-700 rounded-xl p-6 space-y-6">
            ...
            <div>
                ...
                <input type="text" name="slug" value="{{ old('slug', $course->slug ?? '') }}" placeholder="Auto-generated if left blank" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
            </div>
    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col gap-3">
            ...
            <a href="{{ route('admin.language-online-courses.index') }}" class="w-full bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 py-3 rounded-xl font-bold text-center transition-all">
                Cancel
            </a>
        </div>
    </div>
