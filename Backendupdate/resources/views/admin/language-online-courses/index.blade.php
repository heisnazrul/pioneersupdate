...
@section('header', 'Online Courses')

@section('content')
<div class="mb-6 flex justify-between items-center">
    <h3 class="text-lg font-semibold text-gray-800 dark:text-white">All Online Courses</h3>
    <a href="{{ route('admin.language-online-courses.create') }}" class="bg-primary-600 hover:bg-primary-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors flex items-center gap-2">
        <i class="fa-solid fa-plus"></i> Add Online Course
    </a>
</div>
    ...
    <div class="overflow-x-auto">
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-750 transition-colors">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    @endif
                                    <span class="text-xs text-primary-600 font-medium">{{ $course->slug }}</span>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex justify-end gap-2">
                                <a href="{{ route('admin.language-online-courses.edit', $course) }}" class="text-gray-400 hover:text-primary-600 transition-colors p-1">
                                    <i class="fa-solid fa-pen-to-square"></i>
                                </a>
                                <form action="{{ route('admin.language-online-courses.destroy', $course) }}" method="POST" onsubmit="return confirm('Delete this online course?')">
                                    @csrf
                                    @method('DELETE')
                ...
                @empty
                    <tr>
                        <td colspan="6" class="px-6 py-10 text-center text-gray-500 italic">No online courses found.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
