...
@section('header', 'New Accommodation')
...
<div class="max-w-6xl">
    ...
    <form action="{{ route('admin.language-school-accommodations.store') }}" method="POST" class="space-y-8">
        @csrf
                        ...
                        <div>
                            ...
                            <select name="branch_id" required class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
                                ...
                                @foreach($branches as $branch)
                                    <option value="{{ $branch->id }}" {{ old('branch_id') == $branch->id ? 'selected' : '' }}>{{ $branch->school->name_en }} - {{ $branch->city->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div>
                            ...
                            <select name="accommodation_type_id" required class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
                                ...
                                @foreach($types as $type)
                                    <option value="{{ $type->id }}" {{ old('accommodation_type_id') == $type->id ? 'selected' : '' }}>{{ $type->name_en }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <select name="bedroom_type_id" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
                                ...
                                @foreach($bedroomTypes as $bt)
                                    <option value="{{ $bt->id }}" {{ old('bedroom_type_id') == $bt->id ? 'selected' : '' }}>{{ $bt->name_en }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div>
                            ...
                            <select name="bathroom_type_id" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
                                ...
                                @foreach($bathroomTypes as $bat)
                                    <option value="{{ $bat->id }}" {{ old('bathroom_type_id') == $bat->id ? 'selected' : '' }}>{{ $bat->name_en }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div>
                            ...
                            <select name="meal_plan_id" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
                                ...
                                @foreach($mealPlans as $mp)
                                    <option value="{{ $mp->id }}" {{ old('meal_plan_id') == $mp->id ? 'selected' : '' }}>{{ $mp->name_en }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="bg-white dark:bg-gray-800 shadow-sm border border-gray-100 dark:border-gray-700 rounded-xl p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 p-4 bg-amber-50 dark:bg-amber-900/10 rounded-lg border border-amber-100 dark:border-amber-900/30">
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" name="summer_supplement_fee" value="{{ old('summer_supplement_fee', 0) }}" class="w-full px-3 py-1.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700">
                        </div>
                        <div>
                            <label class="block text-xs font-medium text-gray-500 mb-1">Start Date</label>
                            <input type="date" name="summer_start_date" value="{{ old('summer_start_date') }}" class="w-full px-3 py-1.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700">
                        </div>
                        <div>
                            <label class="block text-xs font-medium text-gray-500 mb-1">End Date</label>
                            <input type="date" name="summer_end_date" value="{{ old('summer_end_date') }}" class="w-full px-3 py-1.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 p-4 bg-blue-50 dark:bg-blue-900/10 rounded-lg border border-blue-100 dark:border-blue-900/30">
                        ...
                        <div>
                            <label class="block text-xs font-medium text-gray-500 mb-1">Fee ($)</label>
                            <input type="number" step="0.01" name="winter_supplement_fee" value="{{ old('winter_supplement_fee', 0) }}" class="w-full px-3 py-1.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700">
                        </div>
                        <div>
                            <label class="block text-xs font-medium text-gray-500 mb-1">Start Date</label>
                            <input type="date" name="winter_start_date" value="{{ old('winter_start_date') }}" class="w-full px-3 py-1.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700">
                        </div>
                        <div>
                            <label class="block text-xs font-medium text-gray-500 mb-1">End Date</label>
                            <input type="date" name="winter_end_date" value="{{ old('winter_end_date') }}" class="w-full px-3 py-1.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 p-4 bg-gray-50 dark:bg-gray-900/50 rounded-lg border border-gray-100 dark:border-gray-700">
                        ...
                        <div>
                            ...
                            <input type="text" name="other_supplement_name" value="{{ old('other_supplement_name') }}" placeholder="e.g. Christmas Surcharge" class="w-full px-3 py-1.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700">
                        </div>
                        <div>
                            <label class="block text-xs font-medium text-gray-500 mb-1">Fee ($)</label>
                            <input type="number" step="0.01" name="other_supplement_fee" value="{{ old('other_supplement_fee', 0) }}" class="w-full px-3 py-1.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700">
                        </div>
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-xs font-medium text-gray-500 mb-1">Start Date</label>
                                <input type="date" name="other_start_date" value="{{ old('other_start_date') }}" class="w-full px-3 py-1.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700">
                            </div>
                            <div>
                                <label class="block text-xs font-medium text-gray-500 mb-1">End Date</label>
                                <input type="date" name="other_end_date" value="{{ old('other_end_date') }}" class="w-full px-3 py-1.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="space-y-6">
                <div class="bg-white dark:bg-gray-800 shadow-sm border border-gray-100 dark:border-gray-700 rounded-xl p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="weekly_fee" value="{{ old('weekly_fee', 0) }}" required class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Admin/Placement Fee ($) *</label>
                        <input type="number" step="0.01" name="admin_fee" value="{{ old('admin_fee', 0) }}" required class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Security Deposit ($) *</label>
                        <input type="number" step="0.01" name="security_deposit" value="{{ old('security_deposit', 0) }}" required class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
                    </div>
                    <hr class="border-gray-100 dark:border-gray-700">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Min Age Requirement</label>
                        <input type="number" name="min_age" value="{{ old('min_age') }}" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Under 18 Supplement ($)</label>
                        <input type="number" step="0.01" name="under_18_supplement_fee" value="{{ old('under_18_supplement_fee', 0) }}" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
                    </div>
                </div>
                ...
                <button type="submit" class="w-full bg-primary-600 hover:bg-primary-700 text-white py-4 rounded-xl font-bold shadow-lg shadow-primary-500/30 transition-all text-lg">Save Accommodation</button>
            </div>
        </div>
    </form>
</div>
