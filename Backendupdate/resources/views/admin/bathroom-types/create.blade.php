...
@section('title', 'Add Bathroom Type')
...
<form action="{{ route('admin.bathroom-types.store') }}" method="POST" class="space-y-6">@csrf
...
</div><div class="flex justify-end"><button type="submit" class="bg-primary-600 hover:bg-primary-700 text-white px-8 py-3 rounded-lg font-semibold shadow-lg shadow-primary-500/30 transition-all">Create Type</button></div></form></div>
@endsection
