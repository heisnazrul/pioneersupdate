...
@section('header', 'Edit Course Tag')
...
<div class="max-w-4xl">
    ...
    <form action="{{ route('admin.tags.update', $tag) }}" method="POST" class="space-y-6">
        ...
        <div class="flex justify-end gap-3">
            <a href="{{ route('admin.tags.index') }}" class="px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 transition-colors">
                Cancel
            </a>
