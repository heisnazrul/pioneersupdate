...
class UserController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $validated['username'] = $this->resolveUsername(
            $validated['username'] ?? null, $validated['name'], $validated['email']
        );
        ...
        $user->assignPrimaryRole($validated['role']);
    ...
    public function update(Request $request, User $user): RedirectResponse
    {
        ...
        $validated['username'] = $this->resolveUsername(
            $validated['username'] ?? null, $validated['name'], $validated['email'], $user->id
        );
    ...
    {
        $validated = $request->validate(['status' => ['required', Rule::in(User::STATUSES)]]);
