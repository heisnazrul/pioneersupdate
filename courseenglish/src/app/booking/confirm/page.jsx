    ...
    <main className="min-h-screen bg-[#F0F7FC] pb-24 pt-6">
      <div className="container mx-auto px-4">
        <div className="lg:hidden">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="mt-3 text-sm text-slate-600 leading-6">
              Our team will review your request and contact you on WhatsApp to confirm details and
              help you choose the best option before final confirmation.
            </p>
          </div>
          ...
          <div className="mt-6 text-left text-lg font-semibold text-slate-900">Course Details</div>
          <div className="mt-2 rounded-3xl border border-gray-200 bg-white p-4 shadow-sm">
            <div className="text-sm font-medium text-slate-900">Semi-Intensive English Course</div>
            <div className="mt-1 text-xs text-slate-500">Duration: 12 Weeks</div>
            <div className="text-xs text-slate-500">Start Date: March 15, 2025</div>
          </div>

          <div className="mt-6 text-left text-lg font-semibold text-slate-900">Accommodation Details</div>
          <div className="mt-2 rounded-3xl border border-gray-200 bg-white p-4 shadow-sm">
            <div className="text-sm font-medium text-slate-900">Homestay</div>
            <div className="mt-1 text-xs text-slate-500">Single Room - Shared Bathroom - Half Board</div>
          </div>

          <div className="mt-6 text-left text-lg font-semibold text-slate-900">Additional Services</div>
          <div className="mt-2 rounded-3xl border border-gray-200 bg-white p-4 shadow-sm">
            <div className="text-sm font-medium text-slate-900">Airport Pickup</div>
            <div className="mt-1 text-xs text-slate-500">No pickup</div>
          </div>
        ...
        <div className="hidden lg:block">
          <div className="text-center py-24 text-slate-600">Desktop confirm page TBD.</div>
        </div>
      </div>
    </main>
  );
