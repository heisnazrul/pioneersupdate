...
export default function HeroDatePicker({ label, placeholder, selectedDate, onSelect, variant = "default" }) {
    ...
    return (
        <div className="relative w-full" ref={dropdownRef}>
            {/* Trigger */}
            <div
                className={variant === "borderless" ? "cursor-text px-4 py-2 bg-transparent" : "cursor-text rounded-xl border border-[#F6F8FA] bg-white px-8 py-3 2xl:py-4 shadow-sm transition hover:border-blue-300 focus-within:ring-2 focus-within:ring-blue-100"}
