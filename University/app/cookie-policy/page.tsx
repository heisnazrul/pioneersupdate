export const metadata = {
    title: 'Cookie Policy | Pioneers Admissions',
...
export default function CookiePolicyPage() {
    return (
        <main className="bg-white min-h-screen pb-20 pt-32 px-4 md:px-10 xl:px-30 2xl:px-50">
            <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 mb-8">Cookie Policy</h1>
            ...
            <div className="prose prose-lg prose-blue max-w-none text-slate-600">
                <p>
                    This is the Cookie Policy for Pioneers EDU, accessible from our website.
                </p>
